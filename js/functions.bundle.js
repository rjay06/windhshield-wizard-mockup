      ...
      , c = ("undefined" != typeof cnvsOptions && (l = Object.assign({}, l, cnvsOptions)),
    {
      ...
      , o = {
        ...
        breakpoints: function() {
            ...
            Object.keys(a).forEach(function(e) {
                t > a[e].enter && t <= a[e].exit ? c.elBody.classList.add("device-" + e) : (c.elBody.classList.remove("device-" + e),
        ...
        debounce: function(e, t) {
            clearTimeout(c.debounced),
            c.debounced = setTimeout(e, t)
        },
        ...
        getSelector: function(e, t=!0, a=!0) {
            return t ? (e = o.getVars.baseEl !== document ? jQuery(o.getVars.baseEl).find(e) : jQuery(e),
            a && (e = "string" == typeof a ? e.filter(":not(" + a + ")") : e.filter(":not(.customjs)"))) : o.isElement(e) || (e = a ? "string" == typeof a ? o.getVars.baseEl.querySelectorAll(e + ":not(" + a + ")") : o.getVars.baseEl.querySelectorAll(e + ":not(.customjs)") : o.getVars.baseEl.querySelectorAll(e)),
            e
        },
        ...
        cookie: {
            set: function(e, t, a) {
                var i = new Date
                  , a = (i.setTime(i.getTime() + 24 * a * 60 * 60 * 1e3),
        ...
        scrollTo: function(e=0, t=1250, a, i="smooth") {
            ...
            a && "undefined" != typeof jQuery && void 0 !== jQuery.easing.easeOutQuad ? jQuery("body,html").stop(!0).animate({
                scrollTop: Number(e)
            }, Number(t), a) : (t = "scrollBehavior"in document.documentElement.style,
            "function" == typeof window.scroll && t ? window.scroll({
                top: Number(e),
                behavior: i
            }) : (n = o.getVars.elBody,
            r = o.getVars.elRoot,
            ...
            r.scrollIntoView(),
            (s = function() {
                (n.scrollTop > Number(e) || r.scrollTop > Number(e)) && (n.scrollTop -= 20,
                r.scrollTop -= 20,
                setTimeout(s, 10))
            }
            )()))
        ...
        loadCSS: function(e) {
            var t, a = e.file, i = e.id || !1, e = e.cssFolder || !1;
            return !!a && !(i && document.getElementById(i) || ((t = document.createElement("link")).id = i,
        ...
        isFuncTrue: async function(i) {
            var n;
            return "function" == typeof i && (n = 0,
            new Promise(function(e, t) {
                var a;
                i() ? e(!0) : a = setInterval(function() {
                    i() ? (clearInterval(a),
                    e(!0)) : 30 < n && (clearInterval(a),
                    t(!0)),
                    n++
                }, 333)
            }
        ...
        topScrollOffset: function() {
            ...
            c.elBody.classList.contains("is-expanded-menu") && (c.elHeader?.classList.contains("sticky-header") && (e = c.elHeaderWrap.offsetHeight),
            !c.elPageMenu?.classList.contains("dots-menu") && c.elPageMenu?.classList.contains("sticky-page-menu") || (t = 0)),
      ...
      , e = {
        ...
        menuBreakpoint: function() {
            ...
            c.elPageMenu && (void 0 === o.getVars.pageMenuBreakpoint && (o.getVars.pageMenuBreakpoint = o.getVars.menuBreakpoint),
        ...
        setBSTheme: function() {
            c.elBody.classList.contains("dark") ? document.querySelector("html").setAttribute("data-bs-theme", "dark") : (document.querySelector("html").removeAttribute("data-bs-theme"),
...
function(e, t) {
    ...
    return "undefined" !== SEMICOLON && "undefined" !== SEMICOLON.Core && "undefined" !== SEMICOLON.Base && "undefined" !== SEMICOLON.Modules && "undefined" !== SEMICOLON.Mobile && (N = SEMICOLON.Core,
    T = SEMICOLON.Base,
    S = SEMICOLON.Modules,
    t = SEMICOLON.Mobile,
    {
        Logo: {
            init: function(e) {
                if ((e = N.getSelector(e, !1)).length < 1)
                    return !0;
                var t, a, i = N.getVars.elHead;
                e[0].querySelector(".logo-dark") && (t = document.createElement("style"),
                i.appendChild(t),
                a = '.dark #header-wrap:not(.not-dark) #logo [class^="logo-"], .dark .header-row:not(.not-dark) #logo [class^="logo-"] { display: none; } .dark #header-wrap:not(.not-dark) #logo .logo-dark, .dark .header-row:not(.not-dark) #logo .logo-dark { display: flex; }',
                t.appendChild(document.createTextNode(a))),
                e[0].querySelector(".logo-sticky") && (t = document.createElement("style"),
                i.appendChild(t),
                a = '.sticky-header #logo [class^="logo-"] { display: none !important; } .sticky-header #logo .logo-sticky { display: flex !important; }',
                t.appendChild(document.createTextNode(a))),
                e[0].querySelector(".logo-sticky-shrink") && (t = document.createElement("style"),
                i.appendChild(t),
                a = '.sticky-header-shrink #logo [class^="logo-"] { display: none; } .sticky-header-shrink #logo .logo-sticky-shrink { display: flex; }',
                t.appendChild(document.createTextNode(a))),
                e[0].querySelector(".logo-mobile") && (t = document.createElement("style"),
                i.appendChild(t),
        ...
        StickFooterOnSmall: {
            init: function(e) {
                ...
                N.getVars.elAppMenu && N.viewport().height - (N.getVars.elAppMenu.getBoundingClientRect().top + N.getVars.elAppMenu.getBoundingClientRect().height) == 0 && (N.getVars.elFooter.style.marginBottom = N.getVars.elAppMenu.offsetHeight + "px"),
        ...
        Headers: {
            init: function(e) {
                ...
                a || ((a = document.createElement("div")).classList = "header-wrap-clone",
                N.getVars.elHeaderWrap?.parentNode.insertBefore(a, N.getVars.elHeaderWrap?.nextSibling),
                a = e.querySelector(".header-wrap-clone")),
                ...
                P("responsive"),
                re(),
                (e = document.getElementById("header-trigger")) && (e.onclick = function(e) {
                    e.preventDefault(),
                    N.getVars.elBody.classList.contains("open-header") && N.getVars.elBody.classList.toggle("side-header-open")
                }
                ),
        ...
        L = function(e, t, a, i, n) {
            ...
            var r, s, o, l, c = e.closest(t).querySelector(":scope > " + a), d = e.closest(t).querySelectorAll(a);
            ...
            (l = function(e, t, a) {
                N.isHidden(e.closest(t).querySelector(":scope > " + a)) ? (e.closest(t).classList.remove("current"),
                e.closest(t).querySelector(":scope > " + o)?.classList.remove("icon-rotate-90")) : (e.closest(t).classList.add("current"),
                e.closest(t).querySelector(":scope > " + o)?.classList.add("icon-rotate-90"))
            }
            )(n, r, s),
        ...
        ,
        {
            init: function(e) {
                ...
                document.addEventListener("click", function(e) {
                    e.target.closest(".primary-menu-trigger") || e.target.closest(".primary-menu") || (j(),
                    z()),
                    e.target.closest(".primary-menu.on-click") || (t.forEach(function(e) {
                ...
                document.querySelectorAll(".menu-item").forEach(function(e) {
                    ...
                    !e.classList.contains("mega-menu-title") && 0 < e.querySelectorAll(".sub-menu-container").length && e.querySelectorAll(".sub-menu-trigger").length < 1 && ((t = document.createElement("button")).classList = "sub-menu-trigger fa-solid fa-chevron-right",
                    ...
                    [].slice.call(N.getVars.elPrimaryMenus).filter(function(e) {
                        ...
                        e.querySelectorAll(".sub-menu").forEach(function(e) {
                            ...
                            e.addEventListener("mouseenter", function() {
                                ...
                                w(e.querySelectorAll(".mega-menu-content, .sub-menu-container"))
                            }),
        ...
        PageMenu: {
            init: function(e) {
                var t, a, i;
                return (e = N.getSelector(e, !1)).length < 1 || (e = (t = N.getVars.elPageMenu).querySelector("#page-menu-wrap"),
                (a = t.querySelector(".page-menu-wrap-clone")) || ((a = document.createElement("div")).classList = "page-menu-wrap-clone",
        ...
        SliderDimensions: {
            init: function(e) {
                ...
                a.classList.contains("device-up-lg") ? (setTimeout(function() {
                    ...
                    l && (i = t.querySelector(".slider-inner")?.querySelector("*").offsetHeight,
                    t.style.height = i + "px",
                    r) && (r.style.height = i + "px")
                }, 500),
                ...
                a.classList.contains("stretched") || (n = N.getVars.elWrapper.offsetWidth,
                r && (r.style.width = n + "px"))) : (s && (s.style.height = ""),
                e && (e.style.height = ""),
                r && (r.style.width = "",
                r.style.height = "")),
        ...
        SliderMenuClass: {
            init: function(e) {
                return (e = N.getSelector(e, !1)).length < 1 || !N.getVars.elBody.classList.contains("is-expanded-menu") || (!N.getVars.elHeader.classList.contains("ignore-slider") && (N.getVars.elBody.classList.contains("is-expanded-menu") || N.getVars.elHeader.classList.contains("transparent-header-responsive") && !N.getVars.elBody.classList.contains("primary-menu-open")) && (e = N.getVars.elSlider.querySelector(".swiper-slide-active"),
                te(e)),
                !N.getVars.elHeader.classList.contains("ignore-slider") && (N.getVars.elBody.classList.contains("is-expanded-menu") || N.getVars.elHeader.classList.contains("transparent-header-responsive") && !N.getVars.elBody.classList.contains("primary-menu-open")) && (e = N.getVars.elSlider.querySelector(".active-revslide"),
                te(e)),
                T.setBSTheme(),
        ...
        TopSearch: {
            init: function(e) {
                ...
                e[0].onclick = function(e) {
                    ...
                    N.getVars.elBody.classList.contains("top-search-open") ? i?.classList.add("position-relative") : a = setTimeout(function() {
                ...
                ,
                document.addEventListener("click", function(e) {
                    e.target.closest(".top-search-form") || (N.getVars.elBody.classList.remove("top-search-open"),
            ...
            init: function(e) {
                ...
                document.querySelectorAll(".side-panel-trigger").forEach(function(e) {
                    e.onclick = function(e) {
                        ...
                        t.contains("device-touch") && t.contains("side-push-panel") && t.toggle("ohidden")
                    }
                })
            }
        },
        AdaptiveColorScheme: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || (t = document.querySelector("[data-adaptive-light-class],[data-adaptive-dark-class]"),
                N.getVars.elBody.contains(t) && (a = t.getAttribute("data-adaptive-light-class"),
                i = t.getAttribute("data-adaptive-dark-class")),
                n = function(e) {
                    e ? N.getVars.elBody.classList.add("dark") : N.getVars.elBody.classList.remove("dark"),
                    N.getVars.elBody.contains(t) && (e ? (t.classList.remove(a),
                    t.classList.add(i)) : (t.classList.remove(i),
                    t.classList.add(a))),
                    T.setBSTheme()
                }
                ,
                void (window.matchMedia && (n(window.matchMedia("(prefers-color-scheme: dark)").matches),
        ...
        PortfolioAjax: (m = function(e) {
            var t, a = K(e), e = ee(e), i = document.getElementById("portfolio-navigation");
            !document.getElementById("prev-portfolio") && e && ((t = document.createElement("a")).setAttribute("href", "#"),
            t.setAttribute("id", "prev-portfolio"),
            t.setAttribute("data-id", e),
            t.innerHTML = '<i class="bi-arrow-left"></i>',
            t) && i?.insertBefore(t, document.getElementById("close-portfolio")),
            !document.getElementById("next-portfolio") && a && ((e = document.createElement("a")).setAttribute("href", "#"),
            e.setAttribute("id", "next-portfolio"),
            e.setAttribute("data-id", a),
            e.innerHTML = '<i class="bi-arrow-right"></i>',
            e) && i?.insertBefore(e, document.getElementById("close-portfolio"))
        }
        ,
        v = function(a, e, t) {
            t = t || !1;
            ...
            fetch(t).then(function(e) {
                ...
                ,
                N.getVars.portfolioAjax.container.querySelectorAll("img").length < 1) ? b() : (N.imagesLoaded(N.getVars.portfolioAjax.container),
        ...
        ,
        y = function() {
            N.getVars.portfolioAjax.wrapper && 32 < N.getVars.portfolioAjax.wrapper.offsetHeight && (N.getVars.elBody.classList.remove("portfolio-ajax-loading"),
        ...
        b = function() {
            ...
            setTimeout(function() {
                ...
                N.scrollTo(N.getVars.portfolioAjax.wrapperOffset - N.getVars.topScrollOffset - 60, !1, !1)
            }, 500)
        }
        ,
        {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || (N.getVars.portfolioAjax.items = e[0].querySelectorAll(".portfolio-item"),
        ...
        Cursor: {
            init: function(e) {
                ...
                function t(e, t) {
                    ...
                    return a.classList.add(e.split(".")[1]),
                    t.prepend(a),
                ...
                i || t(".cnvs-cursor-follower", a),
                n || t(".cnvs-cursor-dot", a);
        ...
        ResizeVideos: {
            init: function(t) {
                if (N.getSelector(t, !1, !1).length < 1)
                    return !0;
                N.isFuncTrue(function() {
        ...
        PageTransition: {
            init: function(e) {
                ...
                function t() {
                    function e() {
                        i.remove(),
                        "fadeIn" != n && (N.getVars.elWrapper.classList.remove("not-animated"),
        ...
        LazyLoad: {
            init: function(e) {
                if (N.getSelector(e, !1, !1).length < 1)
                    return !0;
                N.isFuncTrue(function() {
                    ...
                    window.lazyLoadInstance = new LazyLoad({
                        ...
                        callback_loaded: function(e) {
                            ...
                            "true" == e.parentNode.getAttribute("data-lazy-container") && N.runContainerModules(e.parentNode)
                        }
                    })
                })
            }
        ...
        DataHeights: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1, !1)).length < 1) || (e.forEach(function(e) {
                    var t, a = e.getAttribute("data-height-xs") || "auto", i = e.getAttribute("data-height-sm") || a, n = e.getAttribute("data-height-md") || i, r = e.getAttribute("data-height-lg") || n, s = e.getAttribute("data-height-xl") || r, o = e.getAttribute("data-height-xxl") || s, l = N.getVars.elBody.classList;
        ...
        Lightbox: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || (l = '<i class="bi-x-lg"></i>',
                    void t.each(function() {
                        var e, t = jQuery(this), a = t.attr("data-lightbox"), i = t.attr("data-close-button") || "outside", n = t.attr("data-disable-under") || 600, r = t.attr("data-content-position") || "auto", s = t.attr("data-zoom"), o = jQuery("body"), i = "inside" == i, r = "fixed" == r;
                        "image" == a && (e = {
                            type: "image",
                            tLoading: "",
                        ...
                        t.magnificPopup(e)),
                        "gallery" == a && (t.find('a[data-lightbox="gallery-item"]').parent(".clone").hasClass("clone") && t.find('a[data-lightbox="gallery-item"]').parent(".clone").find('a[data-lightbox="gallery-item"]').attr("data-lightbox", ""),
                        ...
                        t.on("mfpOpen", function() {
                            ...
                            "" != t && jQuery(jQuery.magnificPopup.instance.container).addClass(t),
                            "" != e && jQuery(jQuery.magnificPopup.instance.bgOverlay).addClass(e)
                        })
                    })))
                })
            }
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        document.querySelector(".modal-cookies-close") && (document.querySelector(".modal-cookies-close").onclick = function() {
                            var e;
        ...
        Animations: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || (t = "animated",
                a = new IntersectionObserver(function(e, c) {
                    e.forEach(function(e) {
                        var t = e.target
                          ...
                          , o = 3e3
                          , l = a.split(" ");
                        return !!t.closest(".fslider.no-thumbs-animate") || !!t.closest(".swiper-slide") || (s = n ? Number(n) + 500 : 500,
                        i && r && (o = Number(r) + s),
                        t.classList.contains("animated") || (t.classList.add("not-animated"),
                        0 < e.intersectionRatio && (setTimeout(function() {
                    ...
                    if ("true" != o)
                        if ("false" == o) {
                            if (!N.getVars.elBody.classList.contains("device-up-lg"))
                                return !0
                        } else if (!N.getVars.elBody.classList.contains("device-up-" + o))
                            return !0;
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        var e = jQuery(this)
                          ...
                          , s = (M(e),
                        N.getVars.isRTL && (r = !1),
                        e.hasClass("portfolio") || e.hasClass("post-timeline") ? e.filter(":not(.has-init-isotope)").isotope({
                            layoutMode: a,
                            isOriginLeft: r,
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || (t.each(function() {
                        var t = jQuery(this)
                          ...
                          , i = i || "activeFilter";
                        if (!jQuery(a).hasClass("grid-container"))
                            return !1;
                        ...
                        e && (t.find("li").removeClass(i),
                        t.find('[data-filter="' + e + '"]').parent("li").addClass(i),
                        jQuery(a).isotope({
                            filter: e
                        })),
                        jQuery(a).on("arrangeComplete layoutComplete", function(e, t) {
                            jQuery(a).addClass("grid-container-filterable"),
                            "gallery" == jQuery(a).attr("data-lightbox") && (jQuery(a).find("[data-lightbox]").removeClass("grid-lightbox-filtered"),
                            t.forEach(function(e) {
                    ...
                    void jQuery(".grid-shuffle").off("click").on("click", function() {
                        ...
                        if (!jQuery(e).hasClass("grid-container"))
                            return !1;
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t, !1)).length < 1 || void t.forEach(function(a) {
                        ...
                        return !a.classList.contains("swiper_wrapper") || a.querySelectorAll(".swiper-slide").length < 1 || (b = a.getAttribute("data-direction") || "horizontal",
                        ...
                        h = a.querySelector(".swiper-pagination") ? (r = a.querySelector(".swiper-pagination"),
                        !0) : (r = "",
                        !1),
                        ...
                        b = new Swiper(a.querySelector(".swiper-parent"),{
                            ...
                            on: {
                                afterInit: function(e) {
                                    var t;
                                    T.sliderDimensions(),
                                    0 < a.querySelectorAll(".yt-bg-player").length && (a.querySelectorAll(".yt-bg-player").forEach(function(e) {
                                    ...
                                    document.querySelectorAll(".swiper-slide-active [data-animate]").forEach(function(t) {
                                        var e, a = t.getAttribute("data-delay"), i = 0, i = a ? Number(a) + 750 : 750;
                                        t.classList.contains("animated") || (t.classList.add("not-animated"),
                                    ...
                                    a.querySelectorAll("[data-animate]").forEach(function(t) {
                                        ...
                                        if (t.closest(".swiper-slide").classList.contains("swiper-slide-active"))
                                            return !0;
                                        (e + " animated").split(" ").forEach(function(e) {
                                            t.classList.remove(e)
                                        }),
                                ...
                                transitionEnd: function(e) {
                                    ...
                                    a.querySelector(".swiper-slide.swiper-slide-active").querySelector(".yt-bg-player.mb_YTPlayer:not(.customjs)") && 1 == g && jQuery(a).find(".swiper-slide.swiper-slide-active").find(".yt-bg-player.mb_YTPlayer:not(.customjs)").YTPPlay(),
                                    a.querySelectorAll(".swiper-slide.swiper-slide-active [data-animate]").forEach(function(t) {
                                        var e, a = t.getAttribute("data-delay"), i = 0, i = a ? Number(a) + 300 : 300;
                                        t.classList.contains("animated") || (t.classList.add("not-animated"),
                                        e = t.getAttribute("data-animate"),
                                        setTimeout(function() {
                                            t.classList.remove("not-animated"),
        ...
        SliderParallax: {
            init: function(e) {
                ...
                N.isFuncTrue(function() {
                    ...
                    }).sliderPx.el.querySelector(".slider-inner") ? E(0, 0, n.sliderPx.inner) : E(0, 0, n.sliderPx.el),
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        e.find(".flexslider").flexslider({
                            ...
                            after: function(e) {
                                0 < e.parents(".grid-container.has-init-isotope").length && !e.hasClass("flexslider-grid-relayout") && (e.parents(".grid-container.has-init-isotope").isotope("layout"),
            ...
            init: function(e) {
                ...
                (e = N.getSelector(e, !1, !1)).length < 1) || (e.forEach(function(e) {
                    ...
                    var i = e.offsetWidth
                      ...
                      , s = n;
                    r < i && (r = i,
                    s = Number(a[1]) * i / Number(a[0])),
                    t.style.width = r + "px",
                    t.style.height = s + "px",
                    n < s && (t.style.left = "",
                    t.style.top = -(s - n) / 2 + "px"),
                    i < r && (t.style.left = -(r - i) / 2 + "px",
                    t.style.top = ""),
                    SEMICOLON.Mobile.any() && !e.classList.contains("no-placeholder") && ("" != (a = t.getAttribute("poster")) && (e.innerHTML += '<div class="video-placeholder" style="background-image: url(' + a + ');"></div>'),
                    t.classList.add("d-none"))
                }),
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t, !0, ".mb_YTPlayer,.customjs")).length < 1 || void t.each(function() {
                        var e, t, a = jQuery(this), i = a.attr("data-video"), n = a.attr("data-mute") || !0, r = a.attr("data-ratio") || "16/9", s = a.attr("data-quality") || "hd720", o = a.attr("data-opacity") || 1, l = a.attr("data-container") || "parent", c = a.attr("data-optimize") || !0, d = a.attr("data-loop") || !0, u = (a.attr("data-controls"),
                        a.attr("data-volume") || 50), p = a.attr("data-start") || 0, g = a.attr("data-stop") || 0, f = a.attr("data-autoplay") || !0, h = a.attr("data-fullscreen") || !1, m = a.attr("data-coverimage") || "", v = a.attr("data-pauseonblur") || !0, y = a.attr("data-playifvisible") || !1;
                        "false" == n && (n = !1),
                        "parent" == l && (l = (e = a.parent()).attr("id") ? "#" + e.attr("id") : (t = "yt-bg-player-parent-" + Math.floor(1e4 * Math.random()),
                        e.attr("id", t),
                        "#" + t)),
                        "false" == c && (c = !1),
                        "false" == d && (d = !1),
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        e.children(".toggle-header").off("click").on("click", function() {
                            return e.toggleClass("toggle-active").children(".toggle-content").slideToggle(Number(t)),
                            !0
                        })
                    }))
                })
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        "closed" != e && t.find(".accordion-header:eq(" + Number(a) + ")").addClass("accordion-active " + i).next().show(),
                        t.find(".accordion-header").off("click").on("click", function() {
                            var e = jQuery(this);
                            return e.next().is(":hidden") ? (t.find(".accordion-header").removeClass("accordion-active " + i).next().slideUp("normal"),
                            e.toggleClass("accordion-active " + i, !0).next().stop(!0, !0).slideDown("normal", function() {
                            ...
                            })) : "true" == n && e.toggleClass("accordion-active " + i, !1).next().stop(!0, !0).slideUp("normal"),
                            !1
                        })
                    }))
                })
        ...
        Countdown: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        var e, t = jQuery(this), a = t.attr("data-format") || "dHMS", i = t.attr("data-since"), n = t.attr("data-year"), r = t.attr("data-month"), s = t.attr("data-day"), o = t.attr("data-hour"), l = t.attr("data-minute"), c = t.attr("data-second"), d = t.attr("data-redirect");
                        n && (e = n),
                ...
                void N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        if (i)
                            ...
                            return console.log("Google Map co-ordinates not entered."),
                            !0;
                        l = l && JSON.parse(l),
                        "false" == r && (r = !1),
                        "true" == u && (u = !0),
        ...
        Twitter: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1, !1)).length < 1) || void e.forEach(function(o) {
                    ...
                    a || ((a = document.createElement("div")).classList.add("alert", "alert-warning", "twitter-widget-alert", "text-center"),
                    o.prepend(a),
                    a.innerHTML = '<div class="spinner-grow spinner-grow-sm me-2" role="status"><span class="visually-hidden">Loading...</span></div> ' + t),
                    fetch(e + "?username=" + l).then(function(e) {
                        return e.json()
                    }).then(function(e) {
                        if ("object" == typeof e && !e.isArray())
                            return !1;
                        a.remove();
                        var t, s = 0;
                        e?.some(function(e) {
                            ...
                            r = e.text.replace(/((https?|s?ftp|ssh)\:\/\/[^"\s\<\>]*[^.,;'">\:\s\<\>\)\]\!])/g, function(e) {
                            ...
                            t.classList.contains("fslider") ? ((i = document.createElement("div")).classList.add("slide"),
                            ...
                            t.querySelector(".slider-wrap").append(i)) : t.innerHTML += '<li><i class="fa-brands fa-x-twitter"></i><div><span>' + r + '</span><small><a href="https://twitter.com/' + a + "/statuses/" + e.id_str + '" target="_blank">' + G(e.created_at) + "</a></small></div></li>",
                            s++)
                        }),
                        o.classList.contains("fslider") && (t = setInterval(function() {
                            1 < o.querySelectorAll(".slide").length && (o.classList.remove("customjs"),
                            setTimeout(function() {
                                S.flexSlider(),
        ...
        Instagram: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1, !1)).length < 1) || void e.forEach(function(e) {
                    var n, r, s, t = e.getAttribute("data-count") || 12, a = e.getAttribute("data-loader") || "include/instagram/instagram.php", i = e.getAttribute("data-fetch-message") || "Fetching Photos from Instagram...";
                    12 < Number(t) && (t = 12),
                    a = a,
                    r = t,
                    t = i,
                    (s = (n = e).closest(".instagram-widget-alert")) || ((s = document.createElement("div")).classList.add("alert", "alert-warning", "instagram-widget-alert", "text-center"),
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        t.find("ul li:has(ul) > a").filter(":not(:has(.sub-menu-indicator))").append('<i class="sub-menu-indicator ' + e + '"></i>'),
                        t.hasClass("on-hover") ? t.find("ul li:has(ul):not(.active)").hover(function(e) {
                            ...
                            var e = jQuery(this);
                            return t.find("ul li").not(e.parents()).removeClass("active"),
                            e.parent().children("ul").slideToggle(Number(a), i, function() {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        ...
                        jQuery(window).on("lazyLoadLoaded", function() {
                            e.find(".lazy").length == e.find(".lazy.lazy-loaded").length && (lazyLoadInstance.update(),
                            setTimeout(function() {
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || (t.each(function() {
                        ...
                        a)
                            for (var r, a = a.split(","), s = "", s = 0; s < a.length; s++)
                                r = Number(a[s]) - 1,
        ...
        Notifications: {
            init: function(f) {
                if (N.getSelector(f, !1, !1).length < 1)
                    return !0;
                N.isFuncTrue(function() {
                    ...
                    if (e) {
                        ...
                        (f = N.getSelector(f)).length < 1)
                            return !0;
                        var t, a, i = f, e = i.attr("data-notify-position") || "top-right", n = i.attr("data-notify-type"), r = i.attr("data-notify-msg") || "Please set a message!", s = i.attr("data-notify-timeout") || 5e3, o = i.attr("data-notify-close") || "true", l = i.attr("data-notify-autohide") || "true", c = "toast-" + Math.floor(1e4 * Math.random()), d = i.attr("data-notify-trigger") || "self", u = i.attr("data-notify-target"), p = "";
                        switch (0 < jQuery(u).length && "self" == d && (bootstrap.Toast.getOrCreateInstance(jQuery(u).get(0)).hide(),
                        jQuery(u).get(0).addEventListener("hidden.bs.toast", function() {
                        ...
                        "self" == d) && g.get(0).addEventListener("hidden.bs.toast", function() {
                            g.parent().remove(),
        ...
        TextRotator: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        var e, t, a, i, n = jQuery(this), r = n.attr("data-typed") || "false", s = n.find(".t-rotate"), o = n.attr("data-rotate") || "fade", l = n.attr("data-speed") || 1200, c = n.attr("data-separator") || ",";
                        "true" == r ? (r = s.html().split(c),
        ...
        d = function(e, t, a=!0) {
            ...
            o = o || Number(s),
            e = e || Number(o),
            l.contains("device-xs") ? i.offset = t : l.contains("device-sm") ? i.offset = n : l.contains("device-md") ? i.offset = r : l.contains("device-lg") ? i.offset = s : l.contains("device-xl") ? i.offset = o : l.contains("device-xxl") && (i.offset = e),
        ...
        ,
        {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || (t = N.filtered(e, "[data-scrollto]"),
        ...
        AjaxForm: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        var i, n, e = jQuery(this), r = jQuery("body"), s = e.find("form").attr("id"), o = e.attr("data-alert-type"), l = e.attr("data-loader"), c = e.find(".form-result"), d = e.attr("data-redirect"), o = o || "notify";
                        ...
                        e.find("form").validate({
                            ...
                            submitHandler: function(a) {
                                if (e.hasClass("custom-submit"))
                                    return jQuery(a).submit(),
                                    !0;
                                c.hide(),
                                "button" == l ? (i = jQuery(a).find("button"),
                                defaultBtnText = i.html(),
                                i.html('<i class="bi-arrow-repeat icon-spin m-0"></i>')) : jQuery(a).find(".form-process").fadeIn(),
                                s && r.removeClass(s + "-ready " + s + "-complete " + s + "-success " + s + "-error").addClass(s + "-processing"),
                                jQuery(a).ajaxSubmit({
                                    target: c,
                                    dataType: "json",
                                    success: function(e) {
                                        if ("button" == l ? i.html(defaultBtnText) : jQuery(a).find(".form-process").fadeOut(),
                                        "error" != e.alert && d)
                                            return window.location.replace(d),
                                            !0;
                                        var t;
                                        "inline" == o ? (n = "error" == e.alert ? "alert-danger" : "alert-success",
                                        c.removeClass("alert-danger alert-success").addClass("alert " + n).html(e.message).slideDown(400)) : "notify" == o && (c.attr("data-notify-type", e.alert).attr("data-notify-msg", e.message).html(""),
                                        S.notifications(c)),
                                        "error" != e.alert ? (jQuery(a).resetForm(),
                                        ...
                                        r.removeClass(s + "-error").addClass(s + "-success")) : (jQuery(a).trigger("formSubmitError", e),
                                        r.removeClass(s + "-success").addClass(s + "-error")),
        ...
        Subscribe: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t)).length < 1 || void t.each(function() {
                        var a, i, n, e = jQuery(this), r = e.attr("data-alert-type"), s = e.attr("data-loader"), o = e.find(".widget-subscribe-form-result"), l = e.attr("data-redirect");
                        e.find("form").validate({
                            submitHandler: function(t) {
                                o.hide(),
                                "button" == s ? (a = jQuery(t).find("button"),
                                i = a.html(),
                                a.html('<i class="bi-arrow-repeat icon-spin nomargin"></i>')) : jQuery(t).find(".bi-envelope-plus").removeClass("bi-envelope-plus").addClass("bi-arrow-repeat icon-spin"),
                                jQuery(t).ajaxSubmit({
                                    target: o,
                                    dataType: "json",
                                    resetForm: !0,
                                    success: function(e) {
                                        if ("button" == s ? a.html(i) : jQuery(t).find(".bi-arrow-repeat").removeClass("bi-arrow-repeat icon-spin").addClass("bi-envelope-plus"),
                                        "error" != e.alert && l)
                                            return window.location.replace(l),
                                            !0;
                                        "inline" == r ? (n = "error" == e.alert ? "alert-danger" : "alert-success",
                                        o.addClass("alert " + n).html(e.message).slideDown(400)) : (o.attr("data-notify-type", e.alert).attr("data-notify-msg", e.message).html(""),
                                        S.notifications(o))
                                    }
                                })
                            }
            ...
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || void e.forEach(function(e) {
                    ...
                    r.addEventListener(a, function() {
                        s = "checkbox" == o ? r.checked ? r.value : 0 : "radio" != o || r.checked ? r.value : "",
                        A(t, s, l, n, r)
                    }),
            ...
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || void e.forEach(function(e) {
                    var t = e.getAttribute("data-shape") || "valley"
                      ...
                      , l = ""
                      , c = "";
                    if (e.classList.contains("shape-divider-complete"))
                        return !0;
                    a < 100 && (a = 100);
                    ...
                    switch (N.getVars.elHead.appendChild(s),
        ...
        Cookies: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1)
                    return !0;
                var a, i = document.querySelector(".gdpr-settings"), n = (i?.getAttribute("data-speed"),
                i?.getAttribute("data-expire") || 30), e = i?.getAttribute("data-delay") || 1500, t = i?.getAttribute("data-persistent"), r = "bottom", s = i?.offsetHeight + 100, o = i?.offsetWidth + 100, l = document.querySelector(".gdpr-cookie-settings"), c = l?.querySelectorAll("[data-cookie-name]");
                if (!i && !l)
                    return !0;
                "true" == t && (N.cookie.set("__cnvs_cookies_accept", ""),
                N.cookie.remove("__cnvs_cookies_decline")),
                i && (i?.classList.contains("gdpr-settings-sm") && i?.classList.contains("gdpr-settings-right") ? r = "right" : i?.classList.contains("gdpr-settings-sm") && (r = "left"),
                "left" == r ? (a = -o,
                i.style.right = "auto",
                i.style.marginLeft = "1rem") : "right" == r ? (a = -o,
                i.style.left = "auto",
                i.style.marginRight = "1rem") : a = -s,
                i.style[r] = a + "px",
                "1" != N.cookie.get("__cnvs_cookies_accept")) && setTimeout(function() {
                ...
                document.querySelectorAll(".gdpr-container")?.forEach(function(t) {
                    ...
                    N.runContainerModules(t)) : t.classList.add("gdpr-content-blocked")
                })
            }
        },
        Quantity: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || void e.forEach(function(e) {
                    ...
                    t.onclick = function(e) {
                        ...
                        if (a && Number(e) >= Number(a))
                            return !1;
                        /^\d+$/.test(e) ? (a = Number(e) + Number(t),
                        i.value = a) : i.value = Number(t),
                        i.dispatchEvent(n)
                    }
                    ,
                    a.onclick = function(e) {
                        ...
                        (!a || a < 0) && (a = 1),
                        /^\d+$/.test(e) ? Number(e) > Number(a) && (a = Number(e) - Number(t),
                        i.value = a) : i.value = Number(t),
                        i.dispatchEvent(n)
                    }
                })
        ...
        ReadMore: {
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || (e.forEach(function(e) {
                    var t, a = e, i = a.getAttribute("data-readmore-size") || "10rem", n = a.getAttribute("data-readmore-speed") || 500, r = a.getAttribute("data-readmore-scrollup") || "false", s = a.getAttribute("data-readmore-trigger") || ".read-more-trigger", o = a.getAttribute("data-readmore-trigger-open") || "Read More", l = a.getAttribute("data-readmore-trigger-close") || "Read Less", e = (a.style.height = "",
                    a.classList.remove("read-more-wrap-open"),
                    a.offsetHeight), c = a.querySelector(s), d = (c.classList.remove("d-none"),
                    e + c.offsetHeight), u = (c.innerHTML = o,
                    n = Number(n),
                    ...
                    a.getAttribute("data-readmore-mask") || "true"), e = a.getAttribute("data-readmore-maskcolor") || "#FFF", c = a.getAttribute("data-readmore-masksize") || "100%", p = ("true" == u ? (t.style.height = c,
                    t.style.backgroundImage = "linear-gradient( " + D(e, 0) + ", " + D(e, 1) + " )",
                    t.classList.add("op-ts", "op-1")) : t.classList.add("d-none"),
                    a.querySelector(s));
                    p.onclick = function(e) {
                        e.preventDefault(),
                        a.classList.contains("read-more-wrap-open") ? (a.style.height = i,
                        a.classList.remove("read-more-wrap-open"),
                        p.innerHTML = o,
                        setTimeout(function() {
                            "true" == r && N.scrollTo(a.offsetTop - N.getVars.topScrollOffset, !1, !1)
                        }, n),
                        "true" == u && t.classList.add("op-ts", "op-1")) : ("false" == l && p.classList.add("d-none"),
                        a.style.height = d + "px",
                        a.style.overflow = "",
                        a.classList.add("read-more-wrap-open"),
                        p && (p.innerHTML = l),
                        "true" == u && (t.classList.remove("op-1"),
        ...
        SchemeToggle: {
            init: function(i) {
                ...
                !((i = N.getSelector(i, !1)).length < 1) && void i.forEach(function(t) {
                    ...
                    k(t),
                    "checkbox" == e ? t.querySelector("input[type=checkbox]").addEventListener("change", function() {
        ...
        Clipboard: {
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    (t = N.getSelector(t, !1)).length < 1 || (r = [],
                    s = 0,
        ...
        Tips: {
            init: function(e) {
                N.isFuncTrue(function() {
                    ...
                    if (e.contains("init-plugin-tips"))
                        return !1;
                    ...
                    r && (r.onclick = function(e) {
                        e.preventDefault(),
                        bootstrap.Toast.getOrCreateInstance(document.getElementById("cnvs-tips-element")).hide(),
                    ...
                    i = !0,
                    (i = "hide" == N.cookie.get("__cnvs_tips_cookies") ? !1 : i) && (e.add("init-plugin-tips"),
                    setTimeout(function() {
                        S.notifications(a)
        ...
        MediaActions: (s = ["ended", "error", "pause", "seeking", "waiting"],
                ...
                (e = N.getSelector(e, !1)).length < 1) || void e.forEach(function(t) {
                    ...
                    s.forEach(function(e) {
                        a.addEventListener(e, function() {
                            t.classList.remove("media-is-playing"),
                            x(a)
                        })
                    }),
                    ...
                    var r = setInterval(function() {
                        4 === a.readyState && (n && (n.innerHTML = O(a.duration)),
                        clearInterval(r))
                    }, 1e3);
                    ...
                    new IntersectionObserver(function(e) {
                        e.forEach(function(e) {
                            ...
                            e.isIntersecting ? setTimeout(function() {
                                ...
                                o && Q(r)
                            }, Number(a)) : (t.classList.remove("is-in-viewport"),
                            i.forEach(function(e) {
                                e && r.classList.remove(e)
                            }),
                            n.forEach(function(e) {
        ...
        {
            init: function(i) {
                if (N.getSelector(i, !1, !1).length < 1)
                    return !0;
                N.isFuncTrue(function() {
                    return "undefined" != typeof fastdom
                }).then(function(e) {
                    ...
                    (a = function(e) {
                        ...
                        e.forEach(function(e) {
                            var t = e.offsetWidth
                              ...
                              , d = {}
                              , l = (l && (1 < (l = l.split("%")).length ? i += n * Number(l[0]) * .01 : 1 == l.length && l[0] && (i += Number(l[0]))),
                            i - n)
                              , n = i + a
                              , u = n - l;
                            d.elem = e,
            ...
            init: function(e) {
                ...
                (e = N.getSelector(e, !1)).length < 1) || void e.forEach(function(e) {
                    ...
                    document.createElement("div"))
                      , i = (a.classList.add("button-inner"),
            ...
            init: function(t) {
                ...
                N.isFuncTrue(function() {
                    ...
                    a = function(e) {
                        ...
                        N.getVars.hash && document.querySelector('[data-bs-target="' + N.getVars.hash + '"]') && setTimeout(function() {
                    ...
                    e.forEach(function(a) {
                        a.addEventListener("shown.bs.tab", function(e) {
                            var t;
                            a.classList.contains("container-modules-loaded") || (t = a.getAttribute("data-bs-target") ? a.getAttribute("data-bs-target") : a.getAttribute("href"),
                            N.runContainerModules(document.querySelector(t)),
                            document.querySelector(t).querySelectorAll(".flexslider").forEach(function(e) {
                                setTimeout(function() {
    ...
    function k(e, t=!1, a=!1) {
        ...
        N.contains(i, N.getVars.elBody) ? (N.classesFn("add", n, e),
        N.classesFn("remove", r, e),
        e.classList.add("body-state-toggled"),
        "true" == c && a && localStorage.setItem("cnvsBodyColorScheme", "dark"),
        "checkbox" == l && t ? e.querySelector("input[type=checkbox]").checked = !0 : s && (e.innerHTML = s)) : (N.classesFn("add", r, e),
    ...
    function R(i) {
        fetch(i.loader).then(function(e) {
            ...
            N.viewport(),
            "true" == i.triggerDisable && setTimeout(function() {
    ...
    function A(e, t, a, i, n) {
        if (e && a) {
            ...
            r ? (e.classList.add("condition-fulfilled"),
    ...
    function W(e) {
        !function() {
            if (N.getOptions.scrollExternalLinks != true)
                return;
    ...
    function Y(e, t) {
        var a, i = r(e, t);
        i && (i.removeAttribute("data-onepage-settings"),
        a = d(i, e),
        setTimeout(function() {
            i.hasAttribute("data-onepage-settings") || i.setAttribute("data-onepage-settings", JSON.stringify(a)),
            N.getVars.pageSectionEls = document.querySelectorAll("[data-onepage-settings]")
        }, 1e3))
    }
    function J(e, t, a=!1) {
        var i = r(e, t)
        ...
        "scrollTo" != t && "true" == N.getVars.elOnePageActiveOnClick && ((parent = e.closest(".one-page-menu")).querySelectorAll(N.getVars.elOnePageParentSelector).forEach(function(e) {
            e.classList.remove(N.getVars.elOnePageActiveClass)
        }),
        parent.querySelector('a[data-href="#' + n + '"]').closest(N.getVars.elOnePageParentSelector).classList.add(N.getVars.elOnePageActiveClass)),
    ...
    function $(e) {
        e.sliderPx.el && fastdom.measure(function() {
            ...
            e.body.classList.contains("is-expanded-menu") && !e.isMobile ? e.height + e.sliderPx.offset + 50 > e.scrollPos.y ? (e.classes.add("slider-parallax-visible"),
            e.classes.remove("slider-parallax-invisible"),
            e.scrollPos.y > e.sliderPx.offset ? ("object" == typeof e.sliderPx.el.querySelector(".slider-inner") ? (u = -.4 * (e.scrollPos.y - e.sliderPx.offset),
            p = -.15 * (e.scrollPos.y - e.sliderPx.offset),
            E(0, u, e.sliderPx.inner)) : (u = (e.scrollPos.y - e.sliderPx.offset) / 1.5,
            p = (e.scrollPos.y - e.sliderPx.offset) / 7,
            E(0, u, e.sliderPx.el)),
            E(0, p, e.sliderPx.caption)) : (e.sliderPx.el.querySelector(".slider-inner") ? E(0, 0, e.sliderPx.inner) : E(0, 0, e.sliderPx.el),
            E(0, 0, e.sliderPx.caption))) : (e.classes.add("slider-parallax-invisible"),
            e.classes.remove("slider-parallax-visible")) : (e.sliderPx.el.querySelector(".slider-inner") ? E(0, 0, e.sliderPx.inner) : E(0, 0, e.sliderPx.el),
    ...
    function Z(a) {
        a.sliderPx.el.length < 1 || fastdom.mutate(function() {
            var t;
            a.body.classList.contains("is-expanded-menu") && !a.isMobile ? (t = a.header && a.header.classList.contains("transparent-header") || a.body.classList.contains("side-header") ? 100 : 0,
            a.sliderPx.el.classList.contains("slider-parallax-visible") && a.sliderPx.el.querySelectorAll(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").forEach(function(e) {
    ...
    function te(e) {
        if (e) {
            ...
            if (e.classList.contains("dark")) {
                ...
                N.getVars.elBody.classList.contains("dark") ? (e.classList.add("not-dark"),
                document.querySelector("#header.transparent-header:not(.semi-transparent,.floating-header)").classList.remove("dark"),
                document.querySelector("#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)")?.querySelector("#header-wrap").classList.add("not-dark")) : (document.querySelector("#header.transparent-header:not(.semi-transparent,.floating-header)").classList.remove("dark"),
                N.getVars.elHeaderWrap.classList.remove("not-dark"));
    ...
    function j() {
        ...
        N.getVars.elPrimaryMenus.forEach(function(e) {
            t.classList.contains("is-expanded-menu") ? (e.querySelector(".menu-container")?.classList.remove("d-block", "d-none"),
    ...
    function ae() {
        function a(e) {
            var t, a;
            e && !e.querySelector(".sub-menu-indicator") && ((t = document.createElement("i")).classList.add("sub-menu-indicator"),
            (a = e.closest(".primary-menu")?.getAttribute("data-arrow-class") || "fa-solid fa-caret-down") && a.split(" ").forEach(function(e) {
                t.classList.add(e)
            }),
            e.append(t))
        }
    ...
    function ie() {
        var e, t = N.getVars.elHeader, a = document.querySelector(".include-header");
        ...
        t.hasAttribute("data-sticky-offset") && ("full" == (a = t.getAttribute("data-sticky-offset")) ? (N.getVars.headerWrapOffset = N.viewport().height,
        void 0 !== (e = t.getAttribute("data-sticky-offset-negative")) && (N.getVars.headerWrapOffset = "auto" == e ? N.getVars.headerWrapOffset - t.offsetHeight - 1 : N.getVars.headerWrapOffset - Number(e) - 1)) : N.getVars.headerWrapOffset = Number(a))
    }
    function B(e) {
        !N.getVars.elBody.classList.contains("is-expanded-menu") && "true" != N.getVars.mobileSticky || (window.scrollY > e ? N.getVars.elBody.classList.contains("side-header") || (N.getVars.elHeader.classList.add("sticky-header"),
        P("sticky"),
        N.getVars.elBody.classList.contains("is-expanded-menu") && "true" == N.getVars.stickyShrink && !N.getVars.elHeader.classList.contains("no-sticky") && (window.scrollY - e > Number(N.getVars.stickyShrinkOffset) ? N.getVars.elHeader.classList.add("sticky-header-shrink") : N.getVars.elHeader.classList.remove("sticky-header-shrink"))) : (ne(),
        "true" == N.getVars.mobileSticky && P("responsive")))
    }
    function ne() {
    ...
    function P(e) {
        ...
        if ("responsive" == e) {
            ...
            if (!N.getVars.elHeader.classList.contains("sticky-header"))
                return;
        ...
        if (0 < a)
            for (var i = 0, i = 0; i < a; i++)
                "not-dark" == t[i] ? (N.getVars.elHeader.classList.remove("dark"),
                N.getVars.elHeaderWrap?.classList.contains(".not-dark") || N.getVars.elHeaderWrap?.classList.add("not-dark")) : ("dark" == t[i] && N.getVars.elHeaderWrap?.classList.remove("not-dark force-not-dark"),
                N.getVars.elHeader.classList.contains(t[i]) || N.getVars.elHeader.classList.add(t[i]));
        T.setBSTheme()
    }
    function re() {
        ...
        e && (e.style.marginTop = "",
        N.getVars.elBody.classList.contains("is-expanded-menu")) && ((t.classList.contains("floating-header") || e.classList.contains("include-topbar")) && (N.getVars.headerHeight = t.offsetHeight + N.offset(t).top),
